    ...
    return<>
        ...
        <div className='bg-tertiary'>
          <div className='container flex justify-center'>
            ...
            <div className='pt-14 pb-14 flex items-center justify-between w-full md:w-2/3'>
              <div>
              ...
              <div className='flex w-fit h-fit justify-center items-center border border-black bg-primary-dark group hover:bg-white'>
                <Link href={"#"} className="py-2 px-7 text-white group-hover:text-primary-dark">Find Now</Link></div>
            </div>
          </div>
        </div>
      </section>
