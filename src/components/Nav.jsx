    ...
    return <>
        <ul className='gap-4 py-8 text-base flex flex-col  md:flex-row md:mt-0 md:py-0 select-none'>
            ...
            <ProtectedComponent role={EMPLOYER}>
                ...
                <li className="hover:text-primary-tint transition duration-150 ease-in-out hover:-translate-y-1 hover:scale-110"><Link href={"/employers/appliedCandidates"}>APPLIED CANDIDATES</Link></li>
            </ProtectedComponent>
        </ul>
        <ul className='gap-4 flex flex-col md:flex-row'>

            {
                !logged_in ? <> <li>
                    ...
                    : <>
                        <li className="flex items-center hover:text-primary-tint transition duration-150 ease-in-out hover:-translate-y-1 hover:scale-110"><Link href={"/profile"}>{user.name}</Link></li>
                        <li>
