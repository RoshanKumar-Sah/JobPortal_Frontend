...
<div className={`container mt-14 md:mt-0 md:absolute top-[40%] w-full md:-ml-3 md:w-4/6`}>
<div className='p-5  bg-secondary-tint border border-secondary-tint rounded-2xl w-full md:rounded-full'>
  <form className='flex flex-col gap-5 md:flex-row md:justify-between'>
    <input type='text' placeholder='Job Title' className='border border-primary-dark rounded-full py-3 px-4 w-full md:w-2/5'/>
    <select placeholder='Job Category' className='text-primary-tint border border-primary-dark rounded-full py-3 px-4 w-full md:w-1/3'>
